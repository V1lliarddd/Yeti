...
$goods = [
    ...
    ["name" => "DC Ply Mens 2016/2017 Snowboard", "categories" =>"Доски и лыжи","price" => 159999,"img_url" => "img/lot-2.jpg"],
    ["name" => "Крепления Union Contact Pro 2015 года размер L/XL", "categories" =>"Крепления","price" => 8000,"img_url" => "img/lot-3.jpg"],
    ["name" => "Ботинки для сноуборда DC Mutiny Charocal", "categories" =>"Ботинки","price" => 10999,"img_url" => "img/lot-4.jpg"],
    ["name" => "Куртка для сноуборда DC Mutiny Charocal", "categories" =>"Одежда","price" => 7500,"img_url" => "img/lot-5.jpg"],
    ["name" =>"Маска Oakley Canopy", "categories" =>"Разное","price" => 5400,"img_url" => "img/lot-6.jpg"]
];
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    <span class="lot__category"><?=$good["categories"]?></span>
